...
struct qt_meta_stringdata_CLASSFloatSliderENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFloatSliderENDCLASS = QtMocHelpers::stringData(
    "FloatSlider"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFloatSliderENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FloatSlider::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFloatSliderENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FloatSlider, std::true_type>
    >,
    nullptr
} };
